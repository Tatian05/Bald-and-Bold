...
public class AutoScroll : MonoBehaviour
{
    ...
    void UpdateScrollToSelected()
    {
        ...
        _selected = _eventSystemScript.CurrentSelectedGO;

        if (_selected == null || _selected.transform.parent != m_ContentRectTransform.transform)
            return;

        m_SelectedRectTransform = _selected.GetComponent<RectTransform>();
